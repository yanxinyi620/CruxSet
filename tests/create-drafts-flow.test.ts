...
it('restores administrator wall drafts using wall-only navigation', () => {
  ...
  expect(readFileSync(resolve('wechat/miniprogram/pages/create/index.wxml'), 'utf8')).toContain('bindtap="openDrafts"')
  ...
  expect(source).toContain('currentUserIsAdmin')
  expect(source).toContain('resumeDraft')
