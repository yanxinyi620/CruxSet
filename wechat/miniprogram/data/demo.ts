...
export const demoWall: Wall = { id: 'wall_demo', name: '日坛 Spraywall', description: 'CruxSet 固定测试墙面', imageFileId: '/assets/mock/ritan-spraywall-0822.jpg', imageWidth: 4096, imageHeight: 3072, geometryType: 'circle', holds, angleOptions: Array.from({ length: 15 }, (_, i) => i * 5), ownerId: 'usr_mock_owner', visibility: 'public', createdAt: 0, updatedAt: 0 }
