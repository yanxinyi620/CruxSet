...
export class ApiSession extends PreviewSession {
  ...
  override async publishWall(id: string, holds: Hold[]) { await this.api.saveWallHolds(id, holds); await this.api.publishWall(id); await this.refresh(); return this.getWall(id) }
