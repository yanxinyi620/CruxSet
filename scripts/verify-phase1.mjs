...
const required=['project.config.json','miniprogram/app.json','miniprogram/app.ts','miniprogram/sitemap.json','config/cloudbase.collections.json','config/cloudbase.rules.json','cloudfunctions/login/index.js','cloudfunctions/saveProblem/index.js','cloudfunctions/deleteProblem/index.js','cloudfunctions/adminWall/index.js','cloudfunctions/adminWall/validation.js','cloudfunctions/getWallImageUrl/index.js','cloudfunctions/wallManager/index.js','cloudfunctions/storageUpload/index.js']
