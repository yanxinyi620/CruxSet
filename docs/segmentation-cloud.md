...
部署前应用全部 D1 迁移，包含 `0010_lab_access.sql`、`0011_lab_quotas.sql` 和 `0012_lab_publish_requests.sql`，再部署 Worker 与页面。命令及迁移注意事项见[Cloudflare 部署](cloudflare-edge-deployment.md)。
