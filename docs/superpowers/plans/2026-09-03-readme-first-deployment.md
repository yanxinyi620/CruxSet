...
- Verify: `README.md`, `docs/reference.md`, `docs/testing.md`, `docs/guides/local-web.md`

- [ ] **Step 1: Check local document targets**

Run `test -f docs/reference.md && test -f docs/testing.md && test -f docs/guides/local-web.md && test -f tools/segmentation-lab/README.md`. Expected: exit code 0.
