...
export function browseProblems(problems: Problem[], filter: Partial<Pick<Problem, 'wallId'|'layoutId'|'angle'|'grade'>>, query = ''): Problem[] { return searchProblems(filterProblems(problems, filter), query) }
